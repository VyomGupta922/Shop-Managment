...
public class mensfootdet extends javax.swing.JFrame {
 public Connection con=null;
    ...
    void staffda()
    {
        try{
            ...
            rst = stmt.executeQuery("select * from mensfoot");
    ...
    private void GoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoActionPerformed
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst2 = stmt.executeQuery("Select * from mensfoot where nme='"+jTextField1.getText()+"'");
