...
{   ArticalNo.setText("");
   ...
   ItemBuy.setText("");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      String[] types = {"TABLE"};
      ResultSet resultset = metdata.getTables(null, null, "LADIES", types);
      if(resultset.next())
      {
        stmt.executeQuery("insert into ladies values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();  
      }
      else
      {
          stmt.executeQuery("create table ladies (arid varchar(30) PRIMARY KEY NOT NULL,nme varchar(50),siz varchar(30),colr varchar(50),totm int)");  
      stmt.executeQuery("insert into ladies values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();
      }
  ...
  catch(SQLException e)
{
    ...
    private void CheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckActionPerformed
        ...
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst = stmt.executeQuery("select * from ladies where arid='"+ArticalNo.getText()+"'");
            while(rst.next())
            {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("DELETE FROM ladies WHERE arid= '"+ArticalNo.getText()+"'");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("update ladies set totm='"+TotalItem.getText()+"' where arid='"+ArticalNo.getText()+"'");
        ...
        try
    {
        ...
        stmt.executeQuery("update ladies set totm= '"+c+"' where arid='"+ArticalNo.getText()+"'");
        JOptionPane.showMessageDialog(null,"data stored");
        clearcontent();
    }
    catch(Exception e)
