...
public class Ladiesfoot extends javax.swing.JFrame {
...
{   ArticalNo.setText("");
   ...
   ItemBuy.setText("");
    ...
    private void initComponents() {
        ...
        jpanel.setBackground(new java.awt.Color(153, 102, 255));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 0));
        jLabel1.setText("Ladies Foot Wear");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      String[] types = {"TABLE"};
      ResultSet resultset = metdata.getTables(null, null, "LADIESFOOT", types);
      if(resultset.next())
      {
            stmt.executeQuery("insert into Ladiesfoot values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+Company.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();  
      }
      else
      {
          stmt.executeQuery("create table Ladiesfoot  (arid varchar(30) PRIMARY KEY NOT NULL,nme varchar(50),siz varchar(30),colr varchar(50),comp varchar(50),totm int)");  
      stmt.executeQuery("insert into Ladiesfoot  values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+Company.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();
      }
  ...
  catch(SQLException e)
{
    ...
    private void CheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckActionPerformed
        ...
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst = stmt.executeQuery("select * from Ladiesfoot  where arid='"+ArticalNo.getText()+"'");
            while(rst.next())
            {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("DELETE FROM Ladiesfoot WHERE arid= '"+ArticalNo.getText()+"'");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("update Ladiesfoot  set totm='"+TotalItem.getText()+"' where arid='"+ArticalNo.getText()+"'");
        ...
        try
    {
        ...
        stmt.executeQuery("update Ladiesfoot  set totm= '"+c+"' where arid='"+ArticalNo.getText()+"'");
        JOptionPane.showMessageDialog(null,"data stored");
        clearcontent();
    }
    catch(Exception e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ladiesfoot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
