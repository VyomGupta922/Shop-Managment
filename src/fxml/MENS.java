...
{   ArticalNo.setText("");
   ...
   ItemBuy.setText("");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      String[] types = {"TABLE"};
      ResultSet resultset = metdata.getTables(null, null, "MENS", types);
      if(resultset.next())
      {
        stmt.executeQuery("insert into mens values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();  
      }
      else
      {
          stmt.executeQuery("create table mens (arid varchar(30) PRIMARY KEY NOT NULL,nme varchar(50),siz varchar(30),colr varchar(50),totm int)");  
      stmt.executeQuery("insert into mens values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();
      }
  ...
  catch(SQLException e)
{
    ...
    private void CheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckActionPerformed
        ...
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst = stmt.executeQuery("select * from mens where arid='"+ArticalNo.getText()+"'");
            while(rst.next())
            {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("DELETE FROM mens WHERE arid= '"+ArticalNo.getText()+"'");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("update mens set totm='"+TotalItem.getText()+"' where arid='"+ArticalNo.getText()+"'");
        ...
        try
    {
        ...
        stmt.executeQuery("update mens set totm= '"+c+"' where arid='"+ArticalNo.getText()+"'");
        JOptionPane.showMessageDialog(null,"data stored");
        clearcontent();
    }
    catch(Exception e)
