...
public class kidssfootdet extends javax.swing.JFrame {
 public Connection con=null;
    ...
    void staffda()
    {
        try{
            ...
            rst = stmt.executeQuery("select * from KIDSFOOT");
    ...
    private void GoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoActionPerformed
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst2 = stmt.executeQuery("select * from KIDSFOOT where nme='"+jTextField1.getText()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensdet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
