...
public class Kidsfoot extends javax.swing.JFrame {
...
{   ArticalNo.setText("");
   ...
   ItemBuy.setText("");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kids Foot Wear");
    ...
    private void getdataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getdataActionPerformed
       new kidssfootdet().setVisible(true);
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      String[] types = {"TABLE"};
      ResultSet resultset = metdata.getTables(null, null, "KIDSFOOT", types);
      if(resultset.next())
      {
            stmt.executeQuery("insert into Kidsfoot values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+Company.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();  
      }
      else
      {
          stmt.executeQuery("create table Kidsfoot  (arid varchar(30) PRIMARY KEY NOT NULL,nme varchar(50),siz varchar(30),colr varchar(50),comp varchar(50),totm int)");  
      stmt.executeQuery("insert into Kidsfoot  values('"+ArticalNo.getText()+"','"+NAME.getText()+"','"+SIZE.getText()+"','"+Colour.getText()+"','"+Company.getText()+"','"+TotalItem.getText()+"')");
            JOptionPane.showMessageDialog(null, "Data Stored");
            clearcontent();
      }
  ...
  catch(SQLException e)
{
    ...
    private void CheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckActionPerformed
        ...
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst = stmt.executeQuery("select * from Kidsfoot  where arid='"+ArticalNo.getText()+"'");
            while(rst.next())
            {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("DELETE FROM Kidsfoot WHERE arid= '"+ArticalNo.getText()+"'");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
             stmt.executeQuery("update Kidsfoot  set totm='"+TotalItem.getText()+"' where arid='"+ArticalNo.getText()+"'");
        ...
        try
    {
        ...
        stmt.executeQuery("update Kidsfoot  set totm= '"+c+"' where arid='"+ArticalNo.getText()+"'");
        JOptionPane.showMessageDialog(null,"data stored");
        clearcontent();
    }
    catch(Exception e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kidsfoot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
