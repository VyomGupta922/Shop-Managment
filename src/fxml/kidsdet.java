...
public class kidsdet extends javax.swing.JFrame {
 public Connection con=null;
    ...
    void staffda()
    {
        try{
            ...
            rst = stmt.executeQuery("select * from kids");
    ...
    private void GoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GoActionPerformed
        try{
            con=connection.ConnectDB();
            stmt=con.createStatement();
            rst2 = stmt.executeQuery("Select * from kids where nme='"+jTextField1.getText()+"'");
